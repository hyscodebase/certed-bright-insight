...
import { ALL_FIELD_KEYS, ALL_OPTIONAL_FIELDS, FREQUENCY_OPTIONS, REPORT_FIELD_CATEGORIES, type ReportFieldsConfig } from "@/lib/report-fields";
      ...
      <Card className="mb-6 animate-fade-in border-border shadow-sm">
        ...
        <CardContent className="space-y-4">
          ...
          {reportFieldsEditMode ? (
            ...
            <div className="flex flex-wrap gap-2">
              {ALL_OPTIONAL_FIELDS.filter(f => currentFrequencyFields.has(f.key)).map((field) => (
